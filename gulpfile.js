...
gulp.task('unit-test', (done) => {
  gulp.src(['dist/**/*.js', '!dist/**/*.spec.js', '!dist/__it/**/*'])
    .pipe(istanbul({
    ...
    .on('finish', () => {
      gulp.src(['dist/**/*.spec.js', '!dist/__it/**/*'], { read: false })
        .pipe(espower())
        .pipe(mocha({
          ui: 'bdd',
          reporter: 'dot',
...
gulp.task('integration-test', (done) => {
  gulp.src(['dist/__it/**/*.spec.js'], { read: false })
    .pipe(espower())
    .pipe(mocha({
      ui: 'bdd',
      reporter: 'dot',
